...
import { doctorDetailStyles, doctorsPageStyles } from '../assets/dummyStyles';
import { useRef, useState, useEffect, useMemo } from 'react';
import { ChevronRight, MousePointer2Off, Search, X, Medal, CircleChevronUp, CircleChevronDown } from 'lucide-react';
            ...
            <div className={doctorsPageStyles.wrapper}>
                ...
                <div className={doctorsPageStyles.searchContainer}>
                    <div className={doctorsPageStyles.searchWrapper}>
                        <input type="text"
                            placeholder='Search doctors by name or specialization...' value={searchTerm}
                        ...
                        {displayedDoctors.length > 0 ? (
                            displayedDoctors.map((doctor, index) => (
                                <div key={doctor.id || `${doctor.name}-${index}`}
                                    ...
                                    <div className={doctorsPageStyles.experienceBadge}>  {/* ← changed */}
