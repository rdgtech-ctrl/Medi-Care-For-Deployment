...
import { Phone, User, Mail, MapPin, Stethoscope, MessageSquare, SendHorizonal } from 'lucide-react';
...
const ContactPage = () => {
    ...
    function handleSubmit(e) {
        ...
        const url = `https://wa.me/1111111111?text=${encodeURIComponent(text)}`;
