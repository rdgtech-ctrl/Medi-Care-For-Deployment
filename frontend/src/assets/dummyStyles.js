...
mainContainer: "relative rounded-3xl shadow-2xl overflow-hidden group bg-white",
...
export const footerStyles = {
  ...
  // Desktop newsletter
  desktopNewsletterContainer: "relative hidden lg:flex lg:items-center",

desktopEmailInput: "w-full pl-6 pr-40 py-3 text-base text-emerald-800 bg-white border-2 border-emerald-200 rounded-full focus:outline-none focus:ring-4 focus:ring-emerald-300 focus:border-emerald-400 transition-all duration-300 shadow-lg placeholder-emerald-400",

desktopSubscribeButton: "absolute right-1 top-1 bottom-1 bg-linear-to-r from-emerald-500 to-green-600 text-white px-4 py-2 rounded-full cursor-pointer transition-all duration-300 flex items-center gap-2 shadow-lg hover:shadow-xl whitespace-nowrap",
