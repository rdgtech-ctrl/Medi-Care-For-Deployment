...
// FIX 1: process.evn → process.env
// FIX 2: STRIPE_KEY → STRIPE_SECRET_KEY
...
export const getAppointmentsByPatient = async (req, res) => {
    try {
        ...
        console.log("GetAppointmentsByPatient Error: ", err);
        return res.status(500).json({ success: false, message: "Server Error" });
    }
};
...
export const createAppointment = async (req, res) => {
    try {
        ...
        // FIX 3: doctoroId → doctorId, clearkUserId → clerkUserId, exisitingBooking → existingBooking
...
export const confirmPayment = async (req, res) => {
    try {
        ...
        if (!stripe) return res.status(500).json({ success: false, message: "Stripe is not setup" });
        ...
        // FIX 4: console.errro → console.error
...
// FIX 6: GetAppointmentsByDoctor → getAppointmentsByDoctor (lowercase g)
...
// FIX 7: getAppointementsByPatient → getAppointmentsByPatient in default export
export default {
    getAppointments,
