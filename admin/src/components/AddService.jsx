...
import { Calendar,Trash2, Plus, XCircle, CheckCircle, AlertTriangle, Clock, Image } from 'lucide-react';
import { useParams } from 'react-router-dom';

const AddService = () => {
    const { serviceId } = useParams(); //  reads :serviceId from the URL
    ...
    }, [serviceId, API_BASE]); //pre fetch for that particular service id present
