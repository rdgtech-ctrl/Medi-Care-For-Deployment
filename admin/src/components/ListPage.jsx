...
import { dashboardStyles, doctorDetailStyles, doctorListStyles } from '../assets/dummyStyles';
import { Search, Filter, User, Users, Star, EyeClosed, Trash2, BadgeIndianRupee } from 'lucide-react';
...
// this function will normalize schedule map: ex- 'YYYY-MM-DD':[slot1,sot2....];
...
// this funciton gives past dates first
...
const ListPage = () => {
    ...
    // to show doctors according to the filters
    ...
    return (
        <div className={doctorDetailStyles.container}>
                ...
                <div className={doctorListStyles.headerTopSection}>
                    <div className={doctorListStyles.headerIconContainer}>
                        <div className={doctorListStyles.headerIcon}>
                            <User size={20} className={doctorListStyles.headerIconSvg} />
                        </div>
                        <div>
            ...
            <main className={doctorListStyles.gridContainer}>
                    ...
                    return (
                        <article key={id} className={doctorListStyles.article}>
                            <div className={doctorListStyles.articleContent}>
                                <img
                                    src={doc.imageUrl || doc.image || "https://placehold.co/100x100"}
                                    alt={doc.name}
                ...
                {filtered.length > 6 && (
                    <div className={doctorListStyles.showMoreContainer}>
                        <button onClick={() => setShowAll((s) => !s)} // ✅ FIXED arrow function
