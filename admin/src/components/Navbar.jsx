...
import {
    Home, UserPlus, Users, Calendar, Grid, PlusSquare, List, X, Menu
} from "lucide-react";
...
const Navbar = () => {
    ...
    // it will toggle the mobile menu when we click esc button : close the menu when we click on esc
    useEffect(() => {
        const onKey = (e) => {
    ...
    // when user signed in , fetch a token and save it in the localStorage
    useEffect(() => {
        let mounted = true;
